...
function Carousel() {
  return (
 <>
     <div class="container mx-auto my-5 bg-light rounded p-5" style={{width: '80%', backgroundColor:'#ffff'}}>
      <h2>Our <span style={{borderBottom:'1px solid purple' }}>Destinations</span></h2>
  <div class="row align-items-center mt-3">
    ...
    <div class="col-lg-6">
      <p>
        ...
        Curabitur efficitur, lectus sit amet ultricies tincidunt, libero leo ultricies ligula, vel laoreet arcu est vel
        quam. Nulla facilisi.
      </p>
    </div>
  </div>
